(function (global, factory) {
  ...
  class index{constructor(){}get _channels(){return this.channels=this.channels?this.channels:{},this.channels}channel(a){return this._channels[a]=this._channels[a]?this._channels[a]:new Channel,this._channels[a]}off(a){delete this._channels[a];}}
  ...
  class Service extends Events{constructor(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},b=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};super(...arguments),this.settings=a,this.options=b;}get validSettings(){return ["url","method","mode","cache","credentials","headers","parameters","redirect","referrerPolicy","body","files"]}get settings(){return this._settings}set settings(a){this._settings=a,this.validSettings.forEach(b=>{a[b]&&(this[b]=a[b]);});}get options(){return this._options||(this._options={}),this._options}set options(a){this._options=a;}get url(){return this.parameters?this._url.concat(this.queryString):this._url}set url(a){this._url=a;}get queryString(){var a="";if(this.parameters){var b=Object.entries(this.parameters).reduce((a,b)=>{var[c,d]=b,e=c.concat("=",d);return a.push(e),a},[]).join("&");a="?".concat(b);}return a}get method(){return this._method}set method(a){this._method=a;}get mode(){return this._mode}set mode(a){this._mode=a;}get cache(){return this._cache}set cache(a){this._cache=a;}get credentials(){return this._credentials}set credentials(a){this._credentials=a;}get headers(){return this._headers}set headers(a){this._headers=a;}get redirect(){return this._redirect}set redirect(a){this._redirect=a;}get referrerPolicy(){return this._referrerPolicy}set referrerPolicy(a){this._referrerPolicy=a;}get body(){return this._body}set body(a){this._body=a;}get files(){return this._files}set files(a){this._files=a;}get parameters(){return this._parameters||null}set parameters(a){this._parameters=a;}get previousAbortController(){return this._previousAbortController}set previousAbortController(a){this._previousAbortController=a;}get abortController(){return this._abortController||(this.previousAbortController=this._abortController),this._abortController=new AbortController,this._abortController}get response(){return this._response}set response(a){this._response=a;}get responseData(){return this._responseData}set responseData(a){this._responseData=a;}abort(){return this.abortController.abort(),this}fetch(){var a=this.validSettings.reduce((a,b)=>(this[b]&&(a[b]=this[b]),a),{});return a.signal=this.abortController.signal,this.previousAbortController&&this.previousAbortController.abort(),fetch(this.url,a).then(a=>(this.response=a,a.json())).then(a=>(this.emit("ready",a,this),a)).catch(a=>(this.emit("error",{message:a},this),a))}fetchSync(){var a=this;return _asyncToGenerator(function*(){var b=a.validSettings.reduce((b,c)=>(a[c]&&(b[c]=a[c]),b),{});if(b.signal=a.abortController.signal,a.previousAbortController&&a.previousAbortController.abort(),a.response=yield fetch(a.url,b),a.responseData=yield a.response.json(),400<=a.responseData.code&&499>=a.responseData.code)throw a.emit("error",a.responseData,a),a.responseData;else a.emit("ready",a.responseData,a);return a.responseData})()}}

  var Model=class extends Events{constructor(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},b=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};super(),this.settings=a,this.options=b,this.emit("ready",{},this);}get uuid(){return this._uuid||(this._uuid=UUID()),this._uuid}get validSettings(){return ["localStorage","defaults","services","serviceEvents","serviceCallbacks","sockets","socketEvents","socketCallbacks"]}get bindableEventClassPropertyTypes(){return ["service","socket"]}get settings(){return this._settings}set settings(a){this._settings=a,this.validSettings.forEach(b=>{a[b]&&(this[b]=a[b]);}),this.bindableEventClassPropertyTypes.forEach(a=>{this.toggleEvents(a,"on");});}get options(){return this._options||(this._options={}),this._options}set options(a){this._options=a;}get services(){return this._services||(this._services={}),this._services}set services(a){this._services=a;}get data(){return this._data||(this._data={}),this._data}get defaults(){return this._defaults||(this._defaults={}),this._defaults}set defaults(a){this._defaults=!0===this.localStorage.sync?0===Object.entries(this.db).length?a:this.db:a,this.set(this.defaults);}get localStorage(){return this._localStorage||{}}set localStorage(a){this._localStorage=a;}get storageContainer(){return {}}get db(){return this._db}get _db(){var a=localStorage.getItem(this.localStorage.endpoint)||JSON.stringify(this.storageContainer);return JSON.parse(a)}set _db(a){a=JSON.stringify(a),localStorage.setItem(this.localStorage.endpoint,a);}resetEvents(a){return ["off","on"].forEach(b=>{this.toggleEvents(a,b);}),this}toggleEvents(a,b){var c=a.concat("s"),d=a.concat("Events"),e=a.concat("Callbacks"),f=this[c]||{},g=this[d]||{},h=this[e]||{};return Object.values(f).length&&Object.values(g).length&&Object.values(h).length&&Object.entries(g).forEach((a)=>{var[c,d]=a,[e,g]=c.split(" "),i=e.substring(0,1),j=e.substring(e.length-1),k=[];"["===i&&"]"===j?k=Object.entries(f).reduce((a,b)=>{var[c,d]=b,f=e.slice(1,-1),g=new RegExp(f);return c.match(g)&&a.push(d),a},[]):f[e]&&k.push(f[e]);var l=h[d];l&&1===l.name.split(" ").length&&(l=l.bind(this)),e&&g&&k.length&&l&&k.forEach(a=>{try{"on"===b?a[b](g,l):"off"===b?a[b](g,l):void 0;}catch(a){throw a}});}),this}setDB(){var a=this._db;switch(arguments.length){case 1:var b=Object.entries(arguments[0]);b.forEach((b)=>{var[c,d]=b;a[c]=d;});break;case 2:var c=arguments[0],d=arguments[1];a[c]=d;}return this._db=a,this}unsetDB(){switch(arguments.length){case 0:delete this._db;break;case 1:var a=this._db,b=arguments[0];delete a[b],this._db=a;}return this}setDataProperty(a,b,c){var d=this.data[a];if(c||this.emit("beforeSet".concat(":",a),{key:a,value:this.get(a)},{key:a,value:b},this),d||Object.defineProperties(this.data,{["_".concat(a)]:{configurable:!0,writable:!0,enumerable:!1},[a]:{configurable:!0,enumerable:!0,get(){return this["_".concat(a)]},set(b){this["_".concat(a)]=b;}}}),this.data[a]=b,d instanceof Model){this.data[a].on("beforeSet",this.emit(event.name,event.data,model)).on("set",this.emit(event.name,event.data,model)).on("beforeUnset",this.emit(event.name,event.data,model)).on("unset",this.emit(event.name,event.data,model));}return c||this.emit("set".concat(":",a),{key:a,value:b},this),this}unsetDataProperty(a,b){return b||this.emit("beforeUnset".concat(":",arguments[0]),this),this.data[a]&&delete this.data[a],b||this.emit("unset".concat(":",arguments[0]),this),this}get(){return arguments[0]?this.data[arguments[0]]:Object.entries(this.data).reduce((a,b)=>{var[c,d]=b;return a[c]=d,a},{})}set(){var a,b,c,d=Array.from(arguments);return 3===d.length?(a=d[0],b=d[1],c=d[2],!c&&this.emit("beforeSet",this.data,Object.assign({},this.data,{[a]:b}),this),this.setDataProperty(a,b,c),!c&&this.emit("set",this.data,this),this.localStorage.endpoint&&this.setDB(arguments[0],arguments[1])):2===d.length?("object"==typeof d[0]&&"boolean"==typeof d[1]?(c=d[1],!c&&this.emit("beforeSet",this.data,Object.assign({},this.data,d[0]),this),Object.entries(d[0]).forEach((a)=>{var[b,d]=a;this.setDataProperty(b,d,c);}),!c&&this.emit("set",this.data,this)):(!c&&this.emit("beforeSet",this.data,Object.assign({},this.data,{[d[0]]:d[1]}),this),this.setDataProperty(d[0],d[1]),!c&&this.emit("set",this.data,this)),this.localStorage.endpoint&&this.setDB(d[0],d[1])):1===d.length&&!Array.isArray(d[0])&&"object"==typeof d[0]&&(!c&&this.emit("beforeSet",this.data,Object.assign({},this.data,d[0]),this),Object.entries(d[0]).forEach((a)=>{var[b,c]=a;this.setDataProperty(b,c),this.localStorage.endpoint&&this.setDB(b,c);}),!c&&this.emit("set",this.data,this)),this}unset(){var a;return 2===arguments.length?(a=arguments[1],!a&&this.emit("beforeUnset",this.data,this),this.unsetDataProperty(arguments[0],a),!a&&this.emit("unset",this)):1===arguments.length?"boolean"==typeof arguments[0]&&(a=arguments[0],!a&&this.emit("beforeUnset",this.data,this),Object.keys(this.data).forEach(b=>{this.unsetDataProperty(b,a);}),!a&&this.emit("unset",this)):(!a&&this.emit("beforeUnset",this.data,this),Object.keys(this.data).forEach(a=>{this.unsetDataProperty(a);}),!a&&this.emit("unset",this)),this.localStorage.endpoint&&this.unsetDB(key),this}parse(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this.data;return Object.entries(a).reduce((a,b)=>{var[c,d]=b;return a[c]=d instanceof Model?d.parse():d,a},{})}};

  class Collection extends Events{constructor(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},b=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};super(),this.settings=a,this.options=b;}get validSettings(){return ["idAttribute","model","modelOptions","defaults","services","serviceEvents","serviceCallbacks","localStorage"]}get bindableEventClassPropertyTypes(){return ["service"]}get settings(){return this._settings}set settings(a){this._settings=a,this.validSettings.forEach(b=>{a[b]&&(this[b]=a[b]);}),this.bindableEventClassPropertyTypes.forEach(a=>{this.toggleEvents(a,"on");});}get options(){return this._options||(this._options={}),this._options}set options(a){this._options=a;}get storageContainer(){return []}get defaultIDAttribute(){return "_id"}get defaults(){return this._defaults}set defaults(a){this._defaults=a,this.add(a);}get uuid(){return this._uuid||(this._uuid=Utilities.UUID()),this._uuid}get models(){return this._models=this._models||this.storageContainer,this._models}set models(a){this._models=a;}get model(){return this._model}set model(a){this._model=a;}get localStorage(){return this._localStorage}set localStorage(a){this._localStorage=a;}get data(){return this._data}get data(){var a=!!Object.keys(this.models).length;return a?this.models.map(a=>a.parse()):[]}get db(){return this._db}get db(){var a=localStorage.getItem(this.localStorage.endpoint)||JSON.stringify(this.storageContainer);return JSON.parse(a)}set db(a){a=JSON.stringify(a),localStorage.setItem(this.localStorage.endpoint,a);}resetEvents(a){return ["off","on"].forEach(b=>{this.toggleEvents(a,b);}),this}toggleEvents(a,b){var c=a.concat("s"),d=a.concat("Events"),e=a.concat("Callbacks"),f=this[c],g=this[d],h=this[e];return f&&g&&h&&Object.entries(g).forEach((a)=>{var[c,d]=a,[e,g]=c.split(" "),i=f[e],j=h[d];if(j&&1===j.name.split(" ").length&&(j=j.bind(this)),e&&g&&i&&j)try{i[b](g,j);}catch(a){}}),this}getModelIndex(a){var b;return this._models.find((c,d)=>{if(null!==c&&c instanceof Model&&c._uuid===a)return b=d,c}),b}removeModelByIndex(a){var b=this._models.splice(a,1,null);return this.emit("remove:model",b[0].parse(),this,b[0]),this}addModel(a){var b;if(a instanceof Model)b=a;else if(this.model){var c=this.model;b=new c({defaults:a},this.modelOptions);}else b=new Model({defaults:a});return b.on("set",(a,b)=>this.emit("change:model",this.parse(),this,b)),this.models.push(b),this.emit("add",b.parse(),this,b),b}add(a){return Array.isArray(a)?a.forEach(a=>this.addModel(a)):this.addModel(a),this.localStorage&&(this.db=this.data),this.emit("change",this.parse(),this),this}remove(a){if(!Array.isArray(a)&&"object"==typeof a){var b=this.getModelIndex(a.uuid);this.removeModelByIndex(b);}else Array.isArray(a)&&a.forEach(a=>{var b=this.getModelIndex(a.uuid);this.removeModelByIndex(b);});return this.models=this.models.filter(a=>null!==a),this._localStorage&&(this.db=this.data),this.emit("remove",this.parse(),this),this}reset(){return this.remove(this._models),this}parse(a){return a=a||this.data||this.storageContainer,JSON.parse(JSON.stringify(a))}}

  class View extends Events{constructor(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},b=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};super(),this.settings=a,this.options=b;}get validSettings(){return ["attributes","elementName","element","insert","template","uiElements","uiElementEvents","uiElementCallbacks","render"]}get settings(){return this._settings}set settings(a){this._settings=a,this.validSettings.forEach(b=>{a[b]&&(this[b]=a[b]);});}get options(){return this._options||(this._options={}),this._options}set options(a){this._options=a;}get elementName(){return this._elementName}set elementName(a){this._elementName=a;}get element(){return this._element||(this._element=document.createElement(this.elementName),Object.entries(this.attributes).forEach((a)=>{var[b,c]=a;this._element.setAttribute(b,c);}),this.elementObserver.observe(this.element,{subtree:!0,childList:!0})),this._element}get elementObserver(){return this._elementObserver=this._elementObserver||new MutationObserver(this.elementObserve.bind(this)),this._elementObserver}set element(a){a instanceof HTMLElement&&(this._element=a);}get attributes(){return this._attributes||{}}set attributes(a){this._attributes=a;}get template(){return this._template}set template(a){this._template=a;}get uiElements(){return this._uiElements||{}}set uiElements(a){this._uiElements=a;}get uiElementEvents(){return this._uiElementEvents||{}}set uiElementEvents(a){this._uiElementEvents=a;}get uiElementCallbacks(){return this._uiElementCallbacks||{}}set uiElementCallbacks(a){this._uiElementCallbacks=a,Object.values(this._uiElementCallbacks).forEach(a=>a.bind(this));}get ui(){var a=this;return this._ui||(this._ui=Object.entries(this.uiElements).reduce((b,c)=>{var[d,e]=c;return Object.defineProperties(b,{[d]:{get(){if("string"==typeof e){var b=a.element.querySelectorAll(e);return 1<b.length?b:b.item(0)}return e instanceof HTMLElement||e instanceof Document||e instanceof Window?e:void 0}}}),b},{}),Object.defineProperties(this._ui,{$element:{get(){return a.element}}})),this._ui}resetUI(){return delete this._ui,this.toggleEvents(),this}elementObserve(a,b){for(var[c,d]of Object.entries(a))switch(d.type){case"childList":d.addedNodes.length&&this.toggleEvents();}}bindEventToElement(a,b,c,d){try{"addEventListener"===b?(this.uiElementCallbacks[d]=this.uiElementCallbacks[d],a[b](c,this.uiElementCallbacks[d])):"removeEventListener"===b?a[b](c,this.uiElementCallbacks[d]):void 0;}catch(a){}}toggleEvents(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null;this.isToggling=!0;var b=this.ui,c=["removeEventListener","addEventListener"];return a?c.forEach(c=>{Object.entries(this.uiElementEvents).forEach((d)=>{var[e,f]=d,[g,h]=e.split(" ");a===g&&(b[g]instanceof NodeList?b[g].forEach(a=>{this.bindEventToElement(a,c,h,f);}):b[g]instanceof HTMLElement&&this.bindEventToElement(b[g],c,h,f));});}):c.forEach(a=>{Object.entries(this.uiElementEvents).forEach((c)=>{var[d,e]=c,[f,g]=d.split(" ");b[f]instanceof NodeList?b[f].forEach(b=>{this.bindEventToElement(b,a,g,e);}):b[f]&&this.bindEventToElement(b[f],a,g,e);});}),this.isToggling=!1,this}autoInsert(){if(this.insert){var a="string"==typeof this.insert.parent?document.querySelector(this.insert.parent):this.insert.parent instanceof HTMLElement?this.insert.parent:null,b=this.insert.method;a.insertAdjacentElement(b,this.element);}return this}autoRemove(){return this.element.parentElement&&this.element.parentElement.removeChild(this.element),this}emptyElement(a){return this.ui[a].innerHTML="",this}renderElementTextContent(a,b){return this.ui[a]&&(this.ui[a].innerHTML=b),this}renderElementAttribute(a,b){return this.ui[a]&&this.ui[a].removeAttribute(b),this}renderElementAttribute(a,b,c){return this.ui[a]&&this.ui[a].setAttribute(b,c),this}renderElement(a,b,c){return this.ui[a]&&this.ui[a].insertAdjacentElement(b,c),this}render(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{};if(this.template){var b=this.template(a);this.element.innerHTML=b;}return this}}
