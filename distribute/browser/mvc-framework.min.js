(function (global, factory) {
  ...
  class Events{constructor(){}get _events(){return this.events=this.events||{},this.events}getEventCallbacks(a){return this._events[a]||{}}getEventCallbackName(a){return a.name.length?a.name:"anonymousFunction"}getEventCallbackGroup(a,b){return a[b]||[]}on(a,b){var c=this.getEventCallbacks(a),d=this.getEventCallbackName(b),e=this.getEventCallbackGroup(c,d);return e.push(b),c[d]=e,this._events[a]=c,this}off(){switch(arguments.length){case 0:delete this.events;break;case 1:var a=arguments[0];delete this._events[a];break;case 2:var a=arguments[0],b=arguments[1],c="string"==typeof b?b:this.getEventCallbackName(b);this._events[a]&&(delete this._events[a][c],0===Object.keys(this._events[a]).length&&delete this._events[a]);}return this}emit(a,b){var c=Object.values(arguments),d=Object.entries(this.getEventCallbacks(a));for(var[e,f]of d)for(var g of f){var h=c.splice(2)||[];g(b,...h);}return this}}

  var Channel=class{constructor(){}get _responses(){return this.responses=this.responses||this.responses,this.responses}response(a,b){return b?void(this._responses[a]=b):this._responses[response]}request(a){if(this._responses[a]){var b=Array.prototype.slice.call(arguments).slice(1);return this._responses[a](...b)}}off(a){if(a)delete this._responses[a];else for(var[b]of Object.keys(this._responses))delete this._responses[b];}};

  var Channels=class{constructor(){}get _channels(){return this.channels=this.channels||{},this.channels}channel(a){return this._channels[a]=this._channels[a]?this._channels[a]:new Channel,this._channels[a]}off(a){delete this._channels[a];}};

  var typeOf=function(a){switch(typeof a){case"object":var b;if(Array.isArray(a))return "array";return null===a?null===a?"null":b:"object";case"string":case"number":case"boolean":case"undefined":case"function":return typeof a;}};

  var UID=function(){var a,b="";for(a=0;32>a;a+=1)8===a||20===a?(b+="-",b+=(0|16*Math.random()).toString(16)):12===a?(b+="-",b+="4"):16===a?(b+="-",b+=(8|4*Math.random()).toString(16)):b+=(0|16*Math.random()).toString(16);return b};
  ...
  class Base extends Events{constructor(a,b){super(...arguments),this.addClassDefaultProperties(),this.addBindableClassProperties(),this._settings=a,this._configuration=b;}get _name(){return this.name}set _name(a){this.name=a;}get _settings(){return this.settings=this.settings||{},this.settings}set _settings(a){this.settings=a||{},this.classDefaultProperties.forEach(a=>{this.settings[a]&&(this["_".concat(a)]=this.settings[a]);}),Object.keys(this.settings).forEach(a=>{-1===this.classDefaultProperties.indexOf(a)&&(this[a]=this.settings[a]);});}get _configuration(){return this.configuration=this.configuration||{},this.configuration}set _configuration(a){this.configuration=a;}get _uiElementSettings(){return this.uiElementSettings=this.uiElementSettings||{},this.uiElementSettings}set _uiElementSettings(a){this.uiElementSettings=a;}getBindableClassPropertyMethods(a){return "data"===a?[a.concat(""),a.concat("Events"),a.concat("Callbacks")]:[a.concat("s"),a.concat("Events"),a.concat("Callbacks")]}capitalizePropertyName(a){if("ui"===a.slice(0,2))return a.replace(/^ui/,"UI");var b=a.substring(0,1).toUpperCase();return a.replace(/^./,b)}addClassDefaultProperties(){return this.classDefaultProperties.forEach(a=>{if(this[a]){var b=this[a];Object.defineProperty(this,a,{writable:!0,value:b}),this["_".concat(a)]=b;}}),this}addBindableClassProperties(){return this.bindableClassProperties&&this.bindableClassProperties.forEach(a=>{var b=this.getBindableClassPropertyMethods(a);b.forEach((c,d)=>{this.addBindableClassProperty(c),d===b.length-1&&this.toggleTargetBindableClassEvents(a,"on");});}),this}addBindableClassProperty(a){var b=this,c=this.capitalizePropertyName(a),d="add".concat(c),e="remove".concat(c);"uiElements"===a&&(b._uiElementSettings=this[a]);var f=this[a];return Object.defineProperties(this,{[a]:{writable:!0,value:f},["_".concat(a)]:{get(){return b[a]=b[a]||{},b[a]},set(c){Object.entries(c).forEach((c)=>{var[d,e]=c;"uiElements"===a?(b._uiElementSettings[d]=e,b["_".concat(a)][d]=b.element.querySelectorAll(e)):b["_".concat(a)][d]=e;});}},[d]:{value:function(){if(2===arguments.length){var c=arguments[0],d=arguments[1];b["_".concat(a)]={[c]:d};}else if(1===arguments.length){var e=arguments[0];b["_".concat(a)]=e;}return this.resetTargetBindableClassEvents(a),b}},[e]:{value:function value(){if(1===arguments.length){var c=arguments[0];"uiElements"===a?(delete b["_".concat(a)][c],delete b["_".concat("uiElementSettings")][c]):delete b["_".concat(a)][c];}else 0===arguments.length&&Object.keys(b["_".concat(a)]).forEach(c=>{"uiElements"===a?(delete b["_".concat(a)][c],delete b["_".concat("uiElementSettings")][c]):delete b["_".concat(a)][c];});return this.resetTargetBindableClassEvents(a),b}}}),f&&this[d](f),this}resetTargetBindableClassEvents(a){return this.toggleTargetBindableClassEvents(a,"off").toggleTargetBindableClassEvents(a,"on")}toggleTargetBindableClassEvents(a,b){return this[a.concat("s")]&&this[a.concat("Events")]&&this[a.concat("Callbacks")]&&Object.entries(this[a.concat("Events")]).forEach((c)=>{var[d,e]=c;try{d=d.split(" ");var f=d[0],g=d[1],h=this[a.concat("s")][f],i=this[a.concat("Callbacks")][e].bind(this);this.toggleTargetBindableClassEvent(a,h,g,i,b);}catch(a){throw new ReferenceError(a)}}),this}toggleTargetBindableClassEvent(a,b,c,d,e){switch(e){case"on":switch(a){case"uiElement":b instanceof NodeList?Array.from(b).forEach(a=>{a[e](c,d);}):b instanceof HTMLElement&&b[e](c,d);break;default:b[e](c,d);}break;case"off":switch(a){case"uiElement":b instanceof NodeList?Array.from(b).forEach(a=>{a[e](c,d);}):b instanceof HTMLElement&&b[e](c,d);break;default:b[e](c,d);}}}}

  class Service extends Base{constructor(){super(...arguments);}get classDefaultProperties(){return ["responseType","type","parameters","url","headers","data"]}get _defaults(){return this.defaults||{contentType:{"Content-Type":"application/json"},responseType:"json"}}get _responseTypes(){return ["","arraybuffer","blob","document","json","text"]}get _responseType(){return this.responseType}set _responseType(a){this._xhr.responseType=this._responseTypes.find(b=>b===a)||this._defaults.responseType;}get _type(){return this.type}set _type(a){this.type=a;}get _parameters(){return this.parameters=this.parameters||{},this.parameters}set _parameters(a){this.parameters=a;}get _url(){return this.url}set _url(a){this.url=a;}get _headers(){return this.headers||[]}set _headers(a){this._headers.length=0,a.forEach(a=>{this._headers.push(a),a=Object.entries(a)[0],this._xhr.setRequestHeader(a[0],a[1]);});}get _data(){return this.data}set _data(a){this.data=a;}get _xhr(){return this.xhr=this.xhr?this.xhr:new XMLHttpRequest,this.xhr}stringParameters(){var a=Object.entries(this._parameters);return a.reduce((b,c,d)=>{var[e,f]=c,g=d===a.length-1?"":"&";return b=b.concat(e,"=",f,g),b},"?")}request(){var a=this._url.concat(this.stringParameters());return new Promise((b,c)=>{200===this._xhr.status&&this._xhr.abort(),this._xhr.open(this.type,a),this._headers=this.settings.headers||[this._defaults.contentType],this._xhr.onload=b,this._xhr.onerror=c,this._xhr.send(this.data);}).then(a=>(this.emit("xhrResolve",{name:"xhrResolve",data:a.currentTarget},this),a)).catch(a=>{throw a})}}

  class Model extends Base{constructor(){super(...arguments);}get storageContainer(){return {}}get defaultIDAttribute(){return "_id"}get bindableClassProperties(){return ["service"]}get classDefaultProperties(){return ["idAttribute","localStorage","histiogram","defaults"]}get _idAttribute(){return this.idAttribute=this.idAttribute||this.defaultIDAttribute,this.idAttribute}set _idAttribute(a){this.idAttribute=a;}get _defaults(){return this.defaults}set _defaults(a){this.defaults=a,this.set(a);}get _isSetting(){return this.isSetting}set _isSetting(a){this.isSetting=a;}get _changing(){return this.changing=this.changing||{},this.changing}get _localStorage(){return this.localStorage}set _localStorage(a){this.localStorage=a;}get _histiogram(){return this.histiogram||{length:1}}set _histiogram(a){this.histiogram=Object.assign(this._histiogram,a);}get _history(){return this.history=this.history||[],this.history}set _history(a){Object.keys(a).length&&this._histiogram.length&&(this._history.unshift(this.parse(a)),this._history.splice(this._histiogram.length));}get _data(){return this.data=this.data||this.storageContainer,this.data}set _data(a){this.data=a;}get db(){return this._db}get _db(){var a=localStorage.getItem(this.localStorage.endpoint)||JSON.stringify(this.storageContainer);return JSON.parse(a)}set _db(a){a=JSON.stringify(a),localStorage.setItem(this.localStorage.endpoint,a);}get(){switch(arguments.length){case 0:return Object.assign({},this._data);case 1:var a=arguments[0];return this._data[a];}}set(){switch(this._history=this.parse(),arguments.length){case 1:this._isSetting=!0;var c=Object.entries(arguments[0]);c.forEach((a,b)=>{var[d,e]=a;b===c.length-1&&(this._isSetting=!1),this.setDataProperty(d,e);});break;case 2:var a=arguments[0],b=arguments[1];this.setDataProperty(a,b);}return this}unset(){switch(this._history=this.parse(),arguments.length){case 0:for(var a of Object.keys(this._data))this.unsetDataProperty(a);break;case 1:var b=arguments[0];this.unsetDataProperty(b);}return this}setDB(){var a=this._db;switch(arguments.length){case 1:var b=Object.entries(arguments[0]);b.forEach((b)=>{var[c,d]=b;a[c]=d;});break;case 2:var c=arguments[0],d=arguments[1];a[c]=d;}return this._db=a,this}unsetDB(){switch(arguments.length){case 0:delete this._db;break;case 1:var a=this._db,b=arguments[0];delete a[b],this._db=a;}return this}setDataProperty(a,b){if(!this._data["_".concat(a)]){var c=this;Object.defineProperties(this._data,{["_".concat(a)]:{configurable:!0,get(){return this[a]},set(b){this[a]=b,c._changing[a]=b,c.localStorage&&c.setDB(a,b);var d=["set",":",a].join(""),e="set";c.emit(d,{name:d,data:{key:a,value:b}},c),c._isSetting||(Object.values(c._changing).length?c.emit(e,{name:e,data:Object.assign({},c._changing,c._data)},c):c.emit(e,{name:e,data:Object.assign({},c._data)},c),delete c.changing);}}});}return this._data["_".concat(a)]=b,this}unsetDataProperty(a){var b=["unset",":",a].join(""),c="unset",d=this._data[a];return delete this._data["_".concat(a)],delete this._data[a],this.emit(b,{name:b,data:{key:a,value:d}},this),this.emit(c,{name:c,data:{key:a,value:d}},this),this}parse(a){return a=a||this._data||this.storageContainer,JSON.parse(JSON.stringify(a))}}

  class Collection extends Base{constructor(){super(...arguments);}get storageContainer(){return []}get defaultIDAttribute(){return "_id"}get bindableClassProperties(){return ["service"]}get classDefaultProperties(){return ["idAttribute","model","defaults"]}get _idAttribute(){return this.idAttribute=this.idAttribute||this.defaultIDAttribute,this.idAttribute}set _idAttribute(a){this.idAttribute=a;}get _defaults(){return this.defaults}set _defaults(a){this.defaults=a,this.set(a);}get _models(){return this.models=this.models||this.storageContainer,this.models}set _models(a){this.models=a.map(a=>{var b=new this.model;return b.set(a),b});}get _model(){return this.model}set _model(a){this.model=a;}get _isSetting(){return this.isSetting}set _isSetting(a){this.isSetting=a;}get _localStorage(){return this.localStorage}set _localStorage(a){this.localStorage=a;}get data(){return this._data}get _data(){return this._models.map(a=>a.parse())}get db(){return this._db}get _db(){var a=localStorage.getItem(this._localStorage.endpoint)||JSON.stringify(this.storageContainer);return JSON.parse(a)}set _db(a){a=JSON.stringify(a),localStorage.setItem(this._localStorage.endpoint,a);}getModelIndex(a){var b;return this._models.find((c,d)=>{if(null!==c){if(c instanceof Model&&c.get(this._idAttribute)===a)return b=d,c;if(c[this._idAttribute]===a)return b=d,c}}),b}getModelID(a){return a instanceof Model?a.get(this._idAttribute):a[this._idAttribute]}removeModelByIndex(a){var b=this._models.splice(a,1,null);return this.emit("remove",{name:"remove"},b[0],this),this}addModel(a){var b;return a instanceof Model?(b=a,b.on("set",()=>{this.emit("change",{name:"change"},this);}),this._models.push(b)):null!==typeof a&&"object"==typeof a&&(b=new this.model,b.set(a),b.on("set",()=>{this.emit("change",{name:"change"},this);}),this._models.push(b)),this.emit("add",{name:"add"},b,this),this}add(a){return this._isSetting=!0,Array.isArray(a)?a.forEach(a=>{this.addModel(a);}):this.addModel(a),this._localStorage&&(this._db=this._data),this._isSetting=!1,this.emit("change",{name:"change",data:this._data},this),this}remove(a){return this._isSetting=!0,Array.isArray(a)?Array.isArray(a)&&a.map(a=>{this.removeModelByIndex(this.getModelIndex(this.getModelID(a)));}):this.removeModelByIndex(this.getModelIndex(this.getModelID(a))),this._models=this._models.filter(a=>null!==a),this._localStorage&&(this._db=this._data),this._isSetting=!1,this.emit("change",{name:"change",data:this._data},this),this}reset(){return this.remove(this._models),console.log(this._models),this}parse(a){return a=a||this._data||this.storageContainer,JSON.parse(JSON.stringify(a))}}

  class View extends Base{constructor(){super(...arguments);}get bindableClassProperties(){return ["uiElement"]}get classDefaultProperties(){return ["elementName","element","attributes","templates","insert"]}get _elementName(){return this._element.tagName}set _elementName(a){this._element||(this._element=document.createElement(a));}get _element(){return this.element}set _element(a){this.element=a,this.elementObserver.observe(this.element,{subtree:!0,childList:!0});}get _attributes(){return this.attributes=this.element.attributes,this.attributes}set _attributes(a){for(var[b,c]of Object.entries(a))"undefined"==typeof c?this._element.removeAttribute(b):this._element.setAttribute(b,c);}get elementObserver(){return this._elementObserver=this._elementObserver||new MutationObserver(this.elementObserve.bind(this)),this._elementObserver}get _insert(){return this.insert=this.insert||null,this.insert}set _insert(a){this.insert=a;}get _templates(){return this.templates=this.templates||{},this.templates}set _templates(a){this.templates=a;}resetUIElements(){var a=Object.assign({},this._uiElementSettings);return this.toggleTargetBindableClassEvents("uiElement","off"),this.removeUIElements(),this.addUIElements(a),this.toggleTargetBindableClassEvents("uiElement","on"),this}elementObserve(a,b){for(var[c,d]of Object.entries(a))switch(d.type){case"childList":this.resetUIElements();}}autoInsert(){var a=this.insert;return a.parent.insertAdjacentElement(a.method,this._element),this}autoRemove(){return this.element&&this.element.parentElement&&this.element.parentElement.removeChild(this.element),this}}
  ...
  var MVC={Events,Channels,Utils,Service,Model,Collection,View,Controller,Router};
