...
function (_MVC$Base) {
  ...
  _createClass(_class, [{
    ...
    set: function set(uiCallbacks) {
      this.uiCallbacks = MVC.Utils.addPropertiesToTargetObject(uiCallbacks, this._uiCallbacks);
    }
  }, {
    ...
    set: function set(observerCallbacks) {
      this.observerCallbacks = MVC.Utils.addPropertiesToTargetObject(observerCallbacks, this._observerCallbacks);
    }
  }, {
    key: "_uiEmitters",
    get: function get() {
