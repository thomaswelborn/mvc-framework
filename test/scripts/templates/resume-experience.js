  ...
  var template = Array(
    '<div data-class="fieldset" data-id="experience">',
      ...
      '<div data-class="field">',
        ...
        '<input type="text" data-id="experience-employer">',
      '</div>',
      '<div data-class="field">',
        '<label>Job Title</label>',
        '<input type="text" data-id="experience-title">',
      '</div>',
      '<div data-class="field">',
        '<label>Start Month/Year</label>',
        '<input type="text" data-id="experience-start">',
      '</div>',
      '<div data-class="field">',
        '<label>End Month/Year</label>',
        '<input type="text" data-id="experience-stop">',
      '</div>',
    '</div>'
  ).join('');
